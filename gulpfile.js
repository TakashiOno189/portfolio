...
const TARGET_BROWSERS = [
  "last 2 versions", //各ブラウザの２世代前までのバージョン
  "ie >= 11", //IE11を担保
];
 ...
 * parallelは並列で実行
 */
exports.default = gulp.series(clean, gulp.parallel(html, cssSass, js, imgImagemin, php, font), gulp.parallel(watchFiles, browserSyncFunc));
